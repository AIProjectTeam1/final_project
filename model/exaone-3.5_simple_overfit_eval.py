...
model = PeftModel.from_pretrained(base_model, "./qlora-exaone-3.5-model_overfit")
model.eval()
...
# CSV 저장
pd.DataFrame(results).to_csv("exaone-3.5_simple_overfit.csv", index=False, encoding="utf-8-sig")
