...
dataset["train"] = dataset["train"].shuffle(seed=42).select(range(100))  # Overfit on 100 samples
...
def format_example(example):
    ...
    # apply_chat_template -> string output (tokenize=False)
...
# 11. Save model
trainer.save_model("./qlora-exaone-3.5-model_overfit")
