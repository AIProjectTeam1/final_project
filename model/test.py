...
base_model_path = "./model-output/qlora-output_v2_explicit_guideline" # LoRA 모델 경로 확인
...
def format_and_tokenize_example(example):
    ...
    tokenized_output = tokenizer(formatted_text, truncation=True, max_length=1536)
